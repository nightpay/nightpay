  ...
  return (
    <>
      <header className="sticky top-0 z-30 border-b border-void-700 bg-void-900/75 backdrop-blur-md">
        ...
        {/* Mobile Flyout Menu */}
        <div
          className={`fixed inset-0 z-40 bg-void-900/95 backdrop-blur-xl transition-all duration-300 md:hidden ${mobileMenuOpen ? 'opacity-100 visible' : 'opacity-0 invisible pointer-events-none'
            }`}
          style={{ top: '64px' }}
        >

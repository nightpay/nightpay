...
export default function TermsPage() {
  const blocks = useMemo(() => parseMarkdown(termsMarkdown), []);
  const toc = useMemo(
    () =>
      blocks
  ...
  return (
    <div className="mx-auto max-w-5xl">
      <section className="mb-6 card card-elevated">
        ...
        <h1 className="mb-2 text-3xl font-bold text-gray-100">NightPay Terms</h1>
        <p className="max-w-3xl text-sm text-gray-400">
          These terms are tuned for NightPay&apos;s privacy-first bounty pools, Midnight contract receipts, Masumi
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          ...
          <a
            href="https://github.com/nightpay/nightpay/blob/master/docs/TERMS.md"
            target="_blank"
            rel="noreferrer"
            className="rounded-lg border border-void-600 px-3 py-1.5 text-xs text-gray-300 transition-colors hover:border-neon-cyan/45 hover:text-neon-cyan"
          >
            Reference: NightPay Terms
          </a>
        </div>
      </section>
